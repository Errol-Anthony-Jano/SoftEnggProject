...
const UpdateIncomeCategoryForm = () => {
    ...
    return (
        <div className="h-full flex flex-col gap-4 p-4">
            <div className="flex flex-col gap-4 h-[90%]"> 
                <CategoryNameField name_label="Enter new name" input_state={categoryName} input_setter={setCategoryName}/>
                <IconPicker type="income" icon_pick_label="Select new icon" input_state={currIcon} input_setter={selectIcon}/>
            </div>
...
export default UpdateIncomeCategoryForm