...
const BaseModal = ({ onClose, display, displayName }) => {
            ...
            <div className="flex flex-col pointer-events-auto z-[1000] rounded-lg w-[40%] h-[65%] bg-[#040708] shadow-[0px_0px_5px_rgba(255,255,255,0.5)] p-4">
                ...
                <form className="h-[90%]">
                    ...
                    <div className="h-[10%] flex justify-center gap-4">
                        <button className="w-1/4 p-2 bg-white text-black rounded-sm">Submit</button>
                        <button className="w-1/4 p-2 rounded-sm border border-white">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
